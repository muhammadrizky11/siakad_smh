			...
			do
				...
				echo '<td>
					...
					<td>
						'.$i_nama.'
						<br>
						<a href="raport_asesmen_pdf.php?swkd='.$i_kd.'&swnis='.$i_nis.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smt='.$smt.'" class="btn btn-danger" target="_blank">RAPORT ASESMEN >></a>
						<a href="raport_proyek_pdf.php?swkd='.$i_kd.'&swnis='.$i_nis.'&tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&smt='.$smt.'" class="btn btn-danger" target="_blank">RAPORT PROYEK >></a>
					</td>
