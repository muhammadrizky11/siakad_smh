...
if ($_POST['btnEX'])
	...
	<thead>
		...
		<td><strong><font color="'.$warnatext.'">Sub Pokok Bahasan / Indikator Pencapaian Kompetensi / Lingkup Materi / Tujuan Pembelajaran</font></strong></td>
