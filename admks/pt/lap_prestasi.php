...
//nilai
$filenya = "lap_prestasi.php";
$judul = "[PRESTASI]. Lap. Per Prestasi";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if ($_POST['btnEX'])
	...
	<h3>LAPORAN PER PRESTASI</h3>
	                   
	<table class="table" border="1">
	<thead>
		<tr valign="top" bgcolor="'.$warnaheader.'">
		<td width="10"><strong><font color="'.$warnatext.'">NO.</font></strong></th>
		<td><strong><font color="'.$warnatext.'">NAMA PRESTASI</font></strong></th>
		<td width="50"><strong><font color="'.$warnatext.'">JUMLAH PRESTASI</font></strong></td>
		</tr>
	...
	//list 
	$qku = mysqli_query($koneksi, "SELECT * FROM m_bk_prestasi ".
	...
	do
		...
		//jumlahnya 
		$qku2 = mysqli_query($koneksi, "SELECT kd FROM siswa_prestasi ".
	...
	//jumlahnya 
	$qku2 = mysqli_query($koneksi, "SELECT * FROM siswa_prestasi");
	$rku2 = mysqli_fetch_assoc($qku2);
	$tku2 = mysqli_num_rows($qku2);
	...
	echo '</tbody>	
		...
		<td align="right"><strong><font color="'.$warnatext.'">TOTAL PRESTASI</font></strong></td>
