...
$filenya = "lap_bln.php";
$judul = "Lap. Per Bulan";
$judul = "[KEUANGAN SISWA]. Lap. Per Bulan";
$judulku = "$judul";
$judulx = $judul;
...
if ($_POST['btnEX'])
	...
	for ($k=1;$k<=12;$k++) 
		...
		//jumlahnya
		$qku = mysqli_query($koneksi, "SELECT DISTINCT(siswa_kode) AS totalnya ".
										"FROM siswa_bayar_rincian ".
										"WHERE round(DATE_FORMAT(bayar_tgl, '%m')) = '$k' ".
	...
	$qyuk3 = mysqli_query($koneksi, "SELECT DISTINCT(siswa_kode) FROM siswa_bayar_rincian ".
										"WHERE round(DATE_FORMAT(bayar_tgl, '%Y')) = '$uthn'");
	...
	<td>&nbsp;</td>
	<td>
	<strong><font color="blue">'.$tyuk3x.'</font></strong> SISWA
	</td>
	
	<td>
	<strong><font color="blue">'.xduit3($yuk31_total).'</font></strong>
	</td>
