...
if ($_POST['btnEX'])
	...
	$sqlcount = "SELECT DISTINCT(siswa_bayar_rincian.bayar_kode) AS kodenya ".
					"FROM siswa_bayar_rincian, m_walikelas ".
					"WHERE m_walikelas.peg_kd = '$kd3_session' ".
					"AND siswa_bayar_rincian.siswa_tapel = m_walikelas.tapel_nama ".
					"AND siswa_bayar_rincian.siswa_kelas = m_walikelas.kelas_nama ".
					"AND siswa_bayar_rincian.nominal_bayar <> 0 ".
					"ORDER BY siswa_bayar_rincian.bayar_tgl DESC";
	$sqlresult = $sqlcount;
...
if (!empty($kunci))
	...
	$sqlcount = "SELECT DISTINCT(siswa_bayar_rincian.bayar_kode) AS kodenya ".
					...
					"AND siswa_bayar_rincian.siswa_kelas = m_walikelas.kelas_nama ".
					"AND siswa_bayar_rincian.nominal_bayar <> 0 ".
					"AND (siswa_bayar_rincian.siswa_tapel LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.siswa_kelas LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.siswa_kode LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.siswa_nama LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.bayar_kode LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.bayar_tgl LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.item_nama LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.item_thn LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.item_bln LIKE '%$kunci%' ".
					"OR siswa_bayar_rincian.nominal_bayar LIKE '%$kunci%') ".
					"ORDER BY siswa_bayar_rincian.bayar_tgl DESC";
	$sqlresult = $sqlcount;
...
//ketahui totalnya
$qyuk2 = mysqli_query($koneksi, "SELECT SUM(siswa_bayar_rincian.nominal_bayar) AS totalnya ".
									"FROM siswa_bayar_rincian, m_walikelas ".
									"WHERE m_walikelas.peg_kd = '$kd3_session' ".
									"AND siswa_bayar_rincian.siswa_tapel = m_walikelas.tapel_nama ".
									"AND siswa_bayar_rincian.siswa_kelas = m_walikelas.kelas_nama ".
