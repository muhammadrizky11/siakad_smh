...
?>
      ...
      <div class="row">
		...
		do
			{
			//nilai
			$ku_tapel = balikin($rku['tapel_nama']);
			$ku_tapel2 = cegah($rku['tapel_nama']);
			$ku_kelas = balikin($rku['kelas_nama']);
			$ku_kelas2 = cegah($rku['kelas_nama']);
			
			
			//ketahui jumlah siswanya
			$qjuk = mysqli_query($koneksi, "SELECT kd FROM m_siswa ".
												"WHERE tapel = '$ku_tapel2' ".
												"AND kelas = '$ku_kelas2'");
	        ...
	        echo '<div class="col-md-3 col-sm-6 col-xs-12">
	          <div class="info-box">
	            ...
	            <div class="info-box-content">
	              <span class="info-box-text">'.$ku_tapel.'. '.$ku_kelas.'</span>
	              <span class="info-box-number">'.$tjuk.' Siswa</span>
	            </div>
