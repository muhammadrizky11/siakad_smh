...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
/////// SISFOKOL_SMK_v6.0_(Code:DaunMuda)                          ///////
...
//walikelas
$qwk = mysqli_query($koneksi, "SELECT m_walikelas.*, m_pegawai.* ".
...
//data mapel
$qpel = mysqli_query($koneksi, "SELECT m_prog_pddkn.* ".
...
//data jenis
$qku = mysqli_query($koneksi, "SELECT * FROM m_prog_pddkn_jns");
...
do
	...
	//data mapel
	$qpel = mysqli_query($koneksi, "SELECT m_prog_pddkn.*, m_prog_pddkn.kd AS pelkd, m_prog_pddkn_kelas.* ".
	...
	if (!empty($tpel))
		...
		do
			...
			//guru
			$quru = mysqli_query($koneksi, "SELECT m_pegawai.* ".
			...
			//nil mapel
			$qxpel = mysqli_query($koneksi, "SELECT * FROM siswa_nilai_raport ".
									"WHERE kd_siswa_kelas = '$skkd' ".
									"AND kd_smt = '$smtkd' ".
...
//nil mapel
$qxpel = mysqli_query($koneksi, "SELECT SUM(nil_raport_pengetahuan_a) AS totalku, ".
...
//nil mapel
$qxpel = mysqli_query($koneksi, "SELECT AVG(nil_raport_pengetahuan_a) AS totalku, ".
...
$qjks = mysqli_query($koneksi, "SELECT * FROM siswa_kelas ".
						"WHERE kd_tapel = '$tapelkd' ".
						"AND kd_kelas = '$kelkd'");
$rjks = mysqli_fetch_assoc($qjks);
$tjks = mysqli_num_rows($qjks);


//nilaine...
$qnilx = mysqli_query($koneksi, "SELECT * FROM siswa_rangking ".
						"WHERE kd_siswa_kelas = '$skkd' ".
						"AND kd_tapel = '$tapelkd' ".
						"AND kd_kelas = '$kelkd' ".
						"AND kd_smt = '$smtkd'");
$rnilx = mysqli_fetch_assoc($qnilx);
$tnilx = mysqli_num_rows($qnilx);
...
//jml. absensi...
$qbsi = mysqli_query($koneksi, "SELECT * FROM siswa_saran ".
						"WHERE kd_siswa_kelas = '$skkd' ".
						"AND kd_smt = '$smtkd'");
$rbsi = mysqli_fetch_assoc($qbsi);
...
if ((($btxno == "1") OR ($btxno == "2")) AND ($stx_no  == "2"))
	...
	//naik...?
	$qnuk = mysqli_query($koneksi, "SELECT * FROM siswa_naik ".
							"WHERE kd_siswa_kelas = '$skkd'");
	...
	//kepala sekolah
	$qks = mysqli_query($koneksi, "SELECT admin_ks.*, m_pegawai.* ".
							"FROM admin_ks, m_pegawai ".
							"WHERE admin_ks.kd_pegawai = m_pegawai.kd");
	$rks = mysqli_fetch_assoc($qks);
	$tks = mysqli_num_rows($qks);
