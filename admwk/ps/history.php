...
if (empty($kunci))
	{
	$sqlcount = "SELECT user_presensi.* ".
					"FROM user_presensi, m_walikelas ".
					"WHERE user_presensi.user_tapel = m_walikelas.tapel_nama ".
					"AND user_presensi.user_kelas = m_walikelas.kelas_nama ".
					"AND m_walikelas.peg_kd = '$kd3_session' ".
					"AND user_presensi.user_jabatan = 'SISWA' ".
					"ORDER BY user_presensi.postdate DESC";
	}
	...
	$sqlcount = "SELECT user_presensi.* ".
					...
					"AND m_walikelas.peg_kd = '$kd3_session' ".
					"AND user_presensi.user_jabatan = 'SISWA' ".
					"AND (user_presensi.user_kode LIKE '%$kunci%' ".
					"OR user_presensi.user_nama LIKE '%$kunci%' ".
					"OR user_presensi.user_kelas LIKE '%$kunci%' ".
					"OR user_presensi.user_tapel LIKE '%$kunci%' ".
					"OR user_presensi.tanggal LIKE '%$kunci%' ".
					"OR user_presensi.telat_ket LIKE '%$kunci%') ".
					"ORDER BY user_presensi.postdate DESC";
	}
