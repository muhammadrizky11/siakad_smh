	...
	<thead>
		<tr valign="top" bgcolor="'.$warnaheader.'">
			...
			do
				{
				//nilai
				$juk_nama = balikin($rjuk['kelas_nama']);
		...
		do
			...
			if ($i_ket == "ISTIRAHAT")
				...
				do
					...
					$juk_nama = cegah($rjuk['kelas_nama']);
					...
					if (!empty($ok_mapel_kode))
						...
						<hr>
						Siswa Hadir : <b>'.$t_hadir.'</b>
						<br>
						Siswa Ijin : <b>'.$t_ijin.'</b>
						<br>
						Siswa Sakit : <b>'.$t_sakit.'</b>
						<br>
						Siswa Alpha : <b>'.$t_alpha.'</b>
						<hr>
						
						Siswa Menuliskan Feedback/Respon : <b>'.$t_respon.'</b>
						<br>
						<hr>
