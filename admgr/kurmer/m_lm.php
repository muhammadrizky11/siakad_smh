...
if ($_POST['btnSMP'])
	...
	mysqli_query($koneksi, "DELETE FROM kurmer_mapel_lm ".
								"WHERE tapel = '$tapelkd' ".
								"AND kelas = '$kelkd' ".
								"AND smt = '$smt' ".
								"AND kode = '$mkode'");	
	...
	for($i=1;$i<=10;$i++)
		...
		//query
		mysqli_query($koneksi, "INSERT INTO kurmer_mapel_lm(kd, tapel, kelas, smt, ".
									"kode, nama, lm_kode, lm_nama, postdate) VALUES ".
...
if ($_POST['btnEX'])
	...
	$sqlcount = "SELECT * FROM kurmer_mapel_lm ".
					"WHERE tapel = '$tapelkd' ".
					"AND kelas = '$kelkd' ".
					"AND smt = '$smt' ".
					"AND kode = '$mkode' ".
	...
	for ($k=1;$k<=25;$k++)
		...
		//nilai
		$qku = mysqli_query($koneksi, "SELECT * FROM kurmer_mapel_lm ".
											"WHERE tapel = '$tapelkd' ".
											"AND kelas = '$kelkd' ".
											"AND smt = '$smt' ".
											"AND kode = '$mkode' ".
	...
	if ($s == "import")
		...
		<tbody>';
			...
			for ($k=1;$k<=10;$k++)
				...
				mysqli_query($koneksi, "INSERT INTO kurmer_mapel_lm(kd, tapel, kelas, ".
											"smt, kode, nama, lm_kode, postdate) VALUES ".
											"('$xyz', '$tapelkd', '$kelkd', ".
