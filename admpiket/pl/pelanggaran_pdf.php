...
//nilai
$filenya = "pelanggaran_pdf.php";
$judul = "[PELANGGARAN]. Bukti Pelanggaran";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
$petugasnya = balikin($nama71_session);
...
$filename = "../../filebox/pdf/$nis/$nis-$namaku-$pkd.pdf";
