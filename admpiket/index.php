...
//nilai
$filenya = "index.php";
$judul = "Selamat Datang, PETUGAS PIKET.";
$judulku = "$judul  [$nm33_session]";
...
//query
$qtyk = mysqli_query($koneksi, "SELECT DISTINCT(pegawai_kd) AS totalnya ".
								"FROM m_mapel");
$rtyk = mysqli_fetch_assoc($qtyk);
...
$qtyk = mysqli_query($koneksi, "SELECT * FROM siswa_pelanggaran ".
									"WHERE sahya = 'false'");
$rtyk = mysqli_fetch_assoc($qtyk);
$jml_pelanggaran_belum = mysqli_num_rows($qtyk);
...
$qtyk = mysqli_query($koneksi, "SELECT * FROM siswa_pelanggaran ".
									"WHERE sahya = 'true'");
$rtyk = mysqli_fetch_assoc($qtyk);
$jml_pelanggaran_sudah = mysqli_num_rows($qtyk);
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jml_pelanggaran_belum;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jml_pelanggaran_sudah;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-12">
	            ...
	            <div class="card">
	              <div class="card-header border-transparent">
	                <h3 class="card-title">Grafik : Login, Entri, Pelanggaran, Presensi, Ijin Masuk, Ijin Pulang</h3>
