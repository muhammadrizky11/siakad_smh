...
$judul = "[IJIN MASUK PULANG]. Lap. Per Siswa";
$judulku = "$judul";
$judulx = $judul;
$s = nosql($_REQUEST['s']);
...
if ($_POST['btnEX'])
	...
	<thead>
		...
		<td width="150"><strong><font color="'.$warnatext.'">JUMLAH IJIN</font></strong></td>
		...
		if ($count != 0)
			...
			do 
				...
				$tyuk_imasuk = mysqli_num_rows($qyuk);
				...
				$tyuk_ipulang = mysqli_num_rows($qyuk);
