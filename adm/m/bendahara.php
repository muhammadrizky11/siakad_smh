...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//del
		mysqli_query($koneksi, "DELETE FROM m_bendahara ".
				"WHERE kd = '$kdix'");
		}
...
if ($_POST['btnTBH'])
	...
	if (empty($pegawai))
		...
		{
		//query
		mysqli_query($koneksi, "INSERT INTO m_bendahara(kd, peg_kd, ".
...
//query
$q = mysqli_query($koneksi, "SELECT * FROM m_bendahara");
