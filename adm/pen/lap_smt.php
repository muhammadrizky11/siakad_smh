...
if ($_POST['btnEX'])
	...
	$fileku = "lap_semester-nilai-mapel.xls";
	...
	<h3>LAP.SEMESTER NILAI MATA PELAJARAN</h3>
	...
	<thead>
		...
		<tr valign="top" bgcolor="'.$warnaheader.'">';
			...
			do
				...
				echo '<td colspan="2">
				<p align="center"><b>SMT 1</b></p>
				</td>
				<td colspan="2">
				<p align="center"><b>SMT 2</b></p>
				</td>';
				}
			while ($rdt = mysqli_fetch_assoc($qdt));
		...
		do
			...
			do
				...
				for ($km=1;$km<=2;$km++)
					{
					//nil.p
					$qku = mysqli_query($koneksi, "SELECT p_na FROM siswa_nilai_smt ".
														"WHERE tapel = '$tapelkd' ".
														"AND kelas = '$kelkd' ".
														"AND smt = '$km' ".
					...
					//nil.k
					$qku = mysqli_query($koneksi, "SELECT k_na FROM siswa_nilai_smt ".
														"WHERE tapel = '$tapelkd' ".
														"AND kelas = '$kelkd' ".
														"AND smt = '$km' ".
														"AND siswa_kode = '$i_nis' ".
