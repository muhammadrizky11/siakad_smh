...
if ($count != 0)
	...
	do 
		...
		$i_uskd = balikin($data['user_kd']);
		$i_uskode = balikin($data['user_kode']);
		$i_usnama = balikin($data['user_nama']);
		...
		<i>'.$i_ket.'</i>
		<br>
		<a href="../../filebox/arsip/'.$i_uskd.'/'.$i_kd.'/'.$i_filex.'" class="btn btn-danger" title="'.$i_judul.'" target="_blank">UNDUH</a>
		</td>
		</tr>';
		}
