...
if ($_POST['btnEX'])
	...
	<thead>
		...
		<td width="150"><strong><font color="'.$warnatext.'">JUMLAH PEGAWAI</font></strong></th>
		</tr>
	...
	for ($k=$tahun-1;$k<=$tahun;$k++)
		...
		<td align="left">
		<strong><font color="'.$warnatext.'">'.$tku21.'</font></strong>
		<br>
		...
		<td align="left">
		<strong><font color="'.$warnatext.'">'.$tku22.'</font></strong>
		<br>
